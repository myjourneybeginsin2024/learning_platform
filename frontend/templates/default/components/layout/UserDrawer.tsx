...
export function UserDrawer({ isOpen, onClose }: UserDrawerProps) {
    ...
    return (
        <>
            ...
            <div
                className={clsx(
                    "fixed bottom-0 left-0 right-0 bg-white z-50 transform transition-transform duration-300 ease-in-out md:hidden rounded-t-[20px] max-h-[90vh] overflow-y-auto flex flex-col",
                ...
                <div className="flex-1 px-4 space-y-4 pb-8">
                    ...
                    <div className="space-y-4">
                        <button className="flex items-center gap-3 w-full text-left">
                            ...
                            <span className="font-medium text-black">Edit Avatar</span>
                        </button>
                        <button className="flex items-center gap-3 w-full text-left">
                            <FileText size={20} className="text-gray-700" />
                            <span className="font-medium text-black">Drafts</span>
                        </button>
                        <button className="flex items-center gap-3 w-full text-left">
                        ...
                        <button className="flex items-center gap-3 w-full text-left">
                            ...
                            <div className="flex flex-col">
                                <span className="font-medium text-black">Earn</span>
                    ...
                    <div className="space-y-4">
                        ...
                        <button className="flex items-center gap-3 w-full text-left justify-between" onClick={() => setIsDarkMode(!isDarkMode)}>
                            <div className="flex items-center gap-3">
                                <Moon size={20} className="text-gray-700" />
                                <span className="font-medium text-black">Dark Mode</span>
                            </div>
                            {/* Toggle Switch */}
                            <div className={clsx("w-10 h-6 rounded-full transition-colors relative", isDarkMode ? "bg-reddit-blue" : "bg-gray-200")}>
